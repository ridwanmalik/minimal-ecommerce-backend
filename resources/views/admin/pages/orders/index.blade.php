                ...
                <tbody>
                    @foreach ($orders as $order)
                        <tr class="gradeU">
                            ...
                            <td>
                                <select class="form-control" name="status" id="order{{ $order->id }}"
                                    onchange="changeStatus('order{{ $order->id }}')"
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <button type="button" class="btn btn-danger" data-toggle="modal"
                                        data-target="#deleteClass{{ $order->id }}">
                                        <i class="far fa-trash-alt"></i>
                                    </button>

                                    <!-- Modal -->
                                    <div class="modal fade" id="deleteClass{{ $order->id }}" tabindex="-1"
