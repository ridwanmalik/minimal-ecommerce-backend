    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                {{-- @livewire('admin.product.create', ['type' => $type]) --}}
                            ...
                            <div class="col-md-9">
                                <div id="menu_name_show">
                                    <input type="text" class="form-control m-b-5" id="menu_name" name="menu_name"
                                        placeholder="Menu Name" value="{{ old('menu_name') ? old('menu_name') : '' }}" />
                                </div>
                                @error('menu_name')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control m-b-5" id="menu_link" name="menu_link"
                                    placeholder="Enter Menu Link" value="{{ old('menu_link') ? old('menu_link') : '' }}"
                                    required />
                                @error('menu_link')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
