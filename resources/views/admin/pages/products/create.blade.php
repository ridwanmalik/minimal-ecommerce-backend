                ...
                <div class="panel-body">
                    <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control m-b-5" id="name" name="name"
                                    placeholder="Product Name" value="{{ old('name') ? old('name') : '' }}" required />
                                @error('name')
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control m-b-5" id="price" name="price"
                                    placeholder="Enter price" value="{{ old('price') ? old('price') : '' }}" required />
                                @error('price')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control m-b-5" id="qty" name="qty"
                                    placeholder="Enter Quantity" value="{{ old('qty') ? old('qty') : '' }}" required />
                                @error('qty')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <textarea type="text" class="form-control m-b-5" id="description" name="description"
                                    placeholder="Enter description">{{ old('description') ? old('description') : '' }}</textarea>
                                @error('description')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-6">
                                <input type="file" class="form-control m-b-5" id="banner" name="image" placeholder="Image"
