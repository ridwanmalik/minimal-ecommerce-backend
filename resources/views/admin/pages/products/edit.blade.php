    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                {{-- @livewire('admin.product.edit', ['product' => $product, 'type' => ]) --}}
                <div class="panel-body">
                    <form action="{{ route('product.update', $product->id) }}" method="post"
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control m-b-5" id="price" name="price"
                                    placeholder="Enter price" value="{{ old('price') ? old('price') : $product->price }}"
                                    required />
                                @error('price')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control m-b-5" id="qty" name="qty"
                                    placeholder="Enter Quantity" value="{{ old('qty') ? old('qty') : $product->qty }}"
                                    required />
                                @error('qty')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-6">
                                <input type="file" class="form-control m-b-5" id="banner" name="image"
                            ...
                            @if ($product->product_image_url)
                                <div class="col-md-3">
                                    <img src="{{ $product->product_image_url }}" class="img-fluid" alt=""
                                        id="previewImg">
                                </div>
                            @else
                                <div class="col-md-3">
                                    <img src="http://via.placeholder.com/640x360" class="img-fluid" alt=""
                                        id="previewImg">
                                </div>
                            @endif
                        </div>
